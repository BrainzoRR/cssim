...
const RADAR_ZONE_POLYGONS = {
  ...
  Nuke: {
    ...
    Ramp: radarPolygon([[0.43, 0.52], [0.5, 0.52], [0.53, 0.65], [0.44, 0.66]], "lower", "view"),
    Decon: radarPolygon([[0.64, 0.55], [0.73, 0.56], [0.74, 0.64], [0.65, 0.64]], "lower", "view"),
    Doors: radarPolygon([[0.53, 0.25], [0.62, 0.25], [0.62, 0.34], [0.53, 0.34]], "lower", "view"),
    "B Site": radarPolygon([[0.49, 0.42], [0.61, 0.42], [0.62, 0.54], [0.48, 0.55]], "lower", "view"),
    Secret: radarPolygon([[0.24, 0.48], [0.36, 0.48], [0.36, 0.62], [0.24, 0.62]], "lower", "view"),
  },
  Dust: {
