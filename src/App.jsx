...
const RADAR_ZONE_POLYGONS = {
  ...
  Nuke: {
    ...
    Ramp: radarPolygon([[0.52, 0.2737], [0.6225, 0.2737], [0.625, 0.4412], [0.5225, 0.4387]], "lower", "absolute"),
    Decon: radarPolygon([[0.1125, 0.345], [0.1512, 0.3438], [0.1487, 0.3063], [0.1113, 0.3088]], "lower", "absolute"),
    Doors: radarPolygon([[0.2462, 0.25], [0.315, 0.25], [0.3162, 0.2787], [0.2462, 0.2787]], "lower", "absolute"),
    "B Site": radarPolygon([[0.2375, 0.1713], [0.24, 0.3212], [0.1462, 0.3187], [0.145, 0.1675]], "lower", "absolute"),
    Secret: radarPolygon([[0.6538, 0.7488], [0.6975, 0.75], [0.6975, 0.6975], [0.6538, 0.6987]], "lower", "absolute"),
  },
  Dust: {
